...
class SpacesApi(object):
    ...
    def update_space(self, space_id, space, **kwargs): # noqa: E501
        """Update Space  # noqa: E501

        Update Space metadata and settings  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_space(space_id, space, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_space_with_http_info(space_id, space, **kwargs)  # noqa: E501

    def update_space_with_http_info(self, space_id, space, **kwargs):  # noqa: E501
        """Update Space  # noqa: E501

        Update Space metadata and settings  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_space_with_http_info(space_id, space, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('space_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['space_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `space_id` when calling `update_space`")  # noqa: E501
        # verify the required parameter 'space' is set
        if self.api_client.client_side_validation and ('space' not in local_var_params or  # noqa: E501
                                                        local_var_params['space'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `space` when calling `update_space`")  # noqa: E501
